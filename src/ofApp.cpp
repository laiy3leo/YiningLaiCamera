...
void ofApp::draw(){
	...
	ofBackgroundGradient(ofColor(0), ofColor(75));
	...
	for (unsigned int i = 0; i < finder.blobs.size(); i++) {
		...
		ofDrawBox(0.5*cur.x + 897, 0.5*cur.y + 490, 0, cur.width - 60);

		ofSetColor(255, 255, 255, 100);
		ofDrawBox(0.65*cur.x + 858, 0.65*cur.y + 505, 25, cur.width - 55);
		ofDrawBox(0.65*cur.x + 858, 0.65*cur.y + 455, 25, cur.width - 55);
		ofDrawBox(0.65*cur.x + 903, 0.65*cur.y + 505, 25, cur.width - 55);
		ofDrawBox(0.65*cur.x + 903, 0.65*cur.y + 455, 25, cur.width - 55);

		ofSetColor(255, 255, 255, 125);
		ofDrawBox(0.70*cur.x + 835, 0.70*cur.y + 515, 30, cur.width - 43);
		ofDrawBox(0.70*cur.x + 835, 0.70*cur.y + 440, 30, cur.width - 43);
		ofDrawBox(0.70*cur.x + 915, 0.70*cur.y + 515, 30, cur.width - 43);
		ofDrawBox(0.70*cur.x + 915, 0.70*cur.y + 440, 30, cur.width - 43);
		
		ofSetColor(255, 255, 255, 150);
		ofDrawBox(0.75*cur.x + 805, 0.75*cur.y + 530, 50, cur.width - 20);
		ofDrawBox(0.75*cur.x + 805, 0.75*cur.y + 420, 50, cur.width - 20);
		ofDrawBox(0.75*cur.x + 935, 0.75*cur.y + 530, 50, cur.width - 20);
		ofDrawBox(0.75*cur.x + 935, 0.75*cur.y + 420, 50, cur.width - 20);

		ofSetColor(255, 255, 255, 175);
		ofDrawBox(cur.x + 740, cur.y + 535, 100, cur.width + 10);
		ofDrawBox(cur.x + 740, cur.y + 370, 100, cur.width + 10);
		ofDrawBox(cur.x + 940, cur.y + 535, 100, cur.width + 10);
		ofDrawBox(cur.x + 940, cur.y + 370, 100, cur.width + 10);

		ofSetColor(255, 255, 255, 200);
		ofDrawBox(1.25*cur.x + 630, 1.25*cur.y + 545, 150, cur.width + 70);
		ofDrawBox(1.25*cur.x + 630, 1.25*cur.y + 315, 150, cur.width + 70);
		ofDrawBox(1.25*cur.x + 995, 1.25*cur.y + 545, 150, cur.width + 70);
		ofDrawBox(1.25*cur.x + 995, 1.25*cur.y + 315, 150, cur.width + 70);

		ofSetColor(255, 255, 255, 225);
		ofDrawBox(1.5*cur.x + 460, 1.5*cur.y + 580, 160, cur.width + 170);
		ofDrawBox(1.5*cur.x + 460, 1.5*cur.y + 245, 160, cur.width + 170);
		ofDrawBox(1.5*cur.x + 1100, 1.5*cur.y + 580, 160, cur.width + 170);
		ofDrawBox(1.5*cur.x + 1100, 1.5*cur.y + 245, 160, cur.width + 170);

		ofSetColor(255, 255, 255, 255);
		ofDrawBox(1.75*cur.x + 185, 1.75*cur.y + 650, 250, cur.width + 370);
		ofDrawBox(1.75*cur.x + 185, 1.75*cur.y + 125, 250, cur.width + 370);
		ofDrawBox(1.75*cur.x + 1340, 1.75*cur.y + 650, 250, cur.width + 370);
		ofDrawBox(1.75*cur.x + 1340, 1.75*cur.y + 125, 250, cur.width + 370);

		ofSetColor(255, 0, 0, 150);
		ofDrawBox(cur.x + 740, cur.y + 370, 100, 85);
		ofSetColor(255, 0, 0, 250);
		ofDrawBox(1.75*cur.x + 1340, 1.75*cur.y + 650, 250, 490);
		ofSetColor(255, 0, 0, 75);
		ofDrawBox(0.65*cur.x + 903, 0.65*cur.y + 455, 25, 30);
